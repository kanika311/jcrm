      ...
      >
        ...
        <div className="px-6 py-4 sm:px-8 sm:py-5 border-b border-blue-100 flex items-start justify-between shrink-0 bg-blue-50/40">
          <div>
            ...
            <h2 className="heading-font text-xl sm:text-2xl font-extrabold text-slate-900 mt-2">
              Scheduling With <span className="text-[#0055FF]">{candidateName}</span>
            </h2>
            <p className="text-xs font-semibold text-slate-500 mt-0.5">{candidateRole} @ JCRM Technologies</p>
          </div>
        ...
        {/* Form */}
        <form onSubmit={handleSendToWhatsApp} className="flex flex-col flex-1 min-h-0 overflow-hidden">
          ...
          <div className="px-6 py-4 sm:px-8 sm:py-4 border-t border-blue-100 bg-slate-50 shrink-0">
            ...
            >
              ...
              Send to Founder on WhatsApp (+{founderPhone})
            </button>
